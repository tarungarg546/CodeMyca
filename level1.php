...
<body>
	...
	<div id="main">
		<div id="header">Problem Set from <font color="red">Level 1</font></div>
		<br>
		<?php
			$level_code=1;
			$name=$_SESSION['username'];
			$id=$_SESSION['user_id'];
			$a=mysqli_query($con,"SELECT * FROM usermyca WHERE id='$id'");
			...
			echo '<a id="ac" href="view_all_submissions.php?name='.$name.'&level='.$level_code.'">You Have Solved:';
			echo $s;
			echo '/';
			echo $total;
			echo "(Points:$points)";
			...
			if ($per>=80) {
				echo "<a id='congrats' href='level2.php'>Congratulation!You can Now proceed to Next Level</a>";
				$level=$b['level'];
				if($level<2)
				mysqli_query($con,"UPDATE usermyca SET level='2' WHERE id='$id'");
			}
