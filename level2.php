<?php
	...
	$id=$_SESSION['user_id'];
	//check whether level2 is unlocked or not
	$level_code=1;
...
<header id="raja" >
	...
	<div id="main">
		...
		<?php
			...
			if ($per>=70) {
				echo "<a id='congrats' href='/codemyca/level3.php'>Congratulation!You can Now proceed to Next Level</a>";
				$level=$b['level'];
				if($level<3)
				mysqli_query($con,"UPDATE usermyca SET level='3' WHERE id='$id'");
			}
